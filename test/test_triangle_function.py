...
from tof.posfunclib import compute_position_triangle
from tof.posfunclib import compute_position_sine
from functools import partial 
from tof.tofmodel import run_tof_model
...
Xfunc_sine = partial(compute_position_sine, v1=-0.3, v2=0.5, w0=2*np.pi/6)
